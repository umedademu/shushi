...
- Switch daily calendar amounts by selecting the monthly profit or expected value total at the top of the calendar.
- Show only the selected amount in each calendar day without a symbol prefix.
